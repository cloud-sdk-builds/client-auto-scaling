...
[`@aws-sdk/client-auto-scaling`](https://www.npmjs.com/package/@aws-sdk/client-auto-scaling/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auto-scaling@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-azL+VyeI750ApURb4q5P/fX8qdtRMIGZBsPVFRplPi42K1X7MiL+Vlppim7FjLS6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auto-scaling": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auto-scaling@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auto-scaling@3.549.0/index.min.mjs": "sha384-azL+VyeI750ApURb4q5P/fX8qdtRMIGZBsPVFRplPi42K1X7MiL+Vlppim7FjLS6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auto-scaling/blob/refs/tags/3.549.0/LICENSE
```
