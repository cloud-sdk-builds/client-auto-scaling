...
[`@aws-sdk/client-auto-scaling`](https://www.npmjs.com/package/@aws-sdk/client-auto-scaling/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auto-scaling@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V+cq5UOysq5ibiqlkwCeqTac2rggrfwGExlrTv1XPF/vBhe4VOkhJN6FjUyeeeuu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-auto-scaling": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auto-scaling@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-auto-scaling@3.128.0/index.min.mjs": "sha384-V+cq5UOysq5ibiqlkwCeqTac2rggrfwGExlrTv1XPF/vBhe4VOkhJN6FjUyeeeuu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-auto-scaling/blob/refs/tags/3.128.0/LICENSE
```
